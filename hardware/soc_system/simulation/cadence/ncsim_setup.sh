...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/kris/intelFPGA/18.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/lua_cpu_0_avalon_master_to_sdram_controller_0_s1_cmd_width_adapter/
...
mkdir -p ./libraries/sdram_controller_0_s1_burst_adapter/
...
mkdir -p ./libraries/sdram_controller_0_s1_agent_rsp_fifo/
mkdir -p ./libraries/sdram_controller_0_s1_agent/
mkdir -p ./libraries/hps_0_h2f_axi_master_agent/
mkdir -p ./libraries/lua_cpu_0_avalon_master_agent/
mkdir -p ./libraries/sdram_controller_0_s1_translator/
mkdir -p ./libraries/lua_cpu_0_avalon_master_translator/
...
mkdir -p ./libraries/nios2_gen2_0_custom_instruction_master_multi_slave_translator0/
mkdir -p ./libraries/nios2_gen2_0_custom_instruction_master_multi_xconnect/
mkdir -p ./libraries/nios2_gen2_0_custom_instruction_master_translator/
mkdir -p ./libraries/sysid_qsys_0/
mkdir -p ./libraries/sysid/
mkdir -p ./libraries/sdram_controller_0/
mkdir -p ./libraries/pll_0/
mkdir -p ./libraries/onchip_memory2_0/
mkdir -p ./libraries/nios2_gen2_0/
mkdir -p ./libraries/lua_cpu_0/
mkdir -p ./libraries/leds_0/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_ociram_default_contents.hex ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_ociram_default_contents.dat ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_ociram_default_contents.mif ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_rf_ram_b.hex ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_rf_ram_b.dat ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_rf_ram_b.mif ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_rf_ram_a.hex ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_rf_ram_a.dat ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_rf_ram_a.mif ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_bht_ram.hex ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_bht_ram.dat ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_bht_ram.mif ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_ic_tag_ram.hex ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_ic_tag_ram.dat ./
  cp -f $QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_ic_tag_ram.mif ./
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_avalon_st_adapter_006_error_adapter_0.sv" -work error_adapter_0                                                    -cdslib ./cds_libs/error_adapter_0.cds.lib                                                   
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_avalon_st_adapter_006.v"                  -work avalon_st_adapter_006                                              -cdslib ./cds_libs/avalon_st_adapter_006.cds.lib                                             
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                        -work lua_cpu_0_avalon_master_to_sdram_controller_0_s1_cmd_width_adapter -cdslib ./cds_libs/lua_cpu_0_avalon_master_to_sdram_controller_0_s1_cmd_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                    -work lua_cpu_0_avalon_master_to_sdram_controller_0_s1_cmd_width_adapter -cdslib ./cds_libs/lua_cpu_0_avalon_master_to_sdram_controller_0_s1_cmd_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                   -work lua_cpu_0_avalon_master_to_sdram_controller_0_s1_cmd_width_adapter -cdslib ./cds_libs/lua_cpu_0_avalon_master_to_sdram_controller_0_s1_cmd_width_adapter.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_rsp_mux_001.sv"                           -work rsp_mux_001                                                        -cdslib ./cds_libs/rsp_mux_001.cds.lib                                                       
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_rsp_demux_006.sv"                         -work rsp_demux_006                                                      -cdslib ./cds_libs/rsp_demux_006.cds.lib                                                     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_rsp_demux_005.sv"                         -work rsp_demux_005                                                      -cdslib ./cds_libs/rsp_demux_005.cds.lib                                                     
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_cmd_mux_006.sv"                           -work cmd_mux_006                                                        -cdslib ./cds_libs/cmd_mux_006.cds.lib                                                       
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                           -work cmd_mux_006                                                        -cdslib ./cds_libs/cmd_mux_006.cds.lib                                                       
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_cmd_mux_005.sv"                           -work cmd_mux_005                                                        -cdslib ./cds_libs/cmd_mux_005.cds.lib                                                       
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_cmd_mux_003.sv"                           -work cmd_mux_003                                                        -cdslib ./cds_libs/cmd_mux_003.cds.lib                                                       
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_cmd_demux_001.sv"                         -work cmd_demux_001                                                      -cdslib ./cds_libs/cmd_demux_001.cds.lib                                                     
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                                        -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_uncmpr.sv"                                 -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"                                   -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"                                    -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"                                        -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"                                        -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"                                     -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                    -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"                                    -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                      -work sdram_controller_0_s1_burst_adapter                                -cdslib ./cds_libs/sdram_controller_0_s1_burst_adapter.cds.lib                               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                      -work nios2_gen2_0_instruction_master_limiter                            -cdslib ./cds_libs/nios2_gen2_0_instruction_master_limiter.cds.lib                           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                       -work nios2_gen2_0_instruction_master_limiter                            -cdslib ./cds_libs/nios2_gen2_0_instruction_master_limiter.cds.lib                           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                               -work nios2_gen2_0_instruction_master_limiter                            -cdslib ./cds_libs/nios2_gen2_0_instruction_master_limiter.cds.lib                           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                      -work nios2_gen2_0_instruction_master_limiter                            -cdslib ./cds_libs/nios2_gen2_0_instruction_master_limiter.cds.lib                           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_router_013.sv"                            -work router_013                                                         -cdslib ./cds_libs/router_013.cds.lib                                                        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_router_012.sv"                            -work router_012                                                         -cdslib ./cds_libs/router_012.cds.lib                                                        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_router_010.sv"                            -work router_010                                                         -cdslib ./cds_libs/router_010.cds.lib                                                        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_router_009.sv"                            -work router_009                                                         -cdslib ./cds_libs/router_009.cds.lib                                                        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_router_008.sv"                            -work router_008                                                         -cdslib ./cds_libs/router_008.cds.lib                                                        
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                               -work sdram_controller_0_s1_agent_rsp_fifo                               -cdslib ./cds_libs/sdram_controller_0_s1_agent_rsp_fifo.cds.lib                              
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                          -work sdram_controller_0_s1_agent                                        -cdslib ./cds_libs/sdram_controller_0_s1_agent.cds.lib                                       
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                   -work sdram_controller_0_s1_agent                                        -cdslib ./cds_libs/sdram_controller_0_s1_agent.cds.lib                                       
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                         -work lua_cpu_0_avalon_master_agent                                      -cdslib ./cds_libs/lua_cpu_0_avalon_master_agent.cds.lib                                     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                     -work sdram_controller_0_s1_translator                                   -cdslib ./cds_libs/sdram_controller_0_s1_translator.cds.lib                                  
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                    -work lua_cpu_0_avalon_master_translator                                 -cdslib ./cds_libs/lua_cpu_0_avalon_master_translator.cds.lib                                
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu.vo"                                        -work cpu                                                                -cdslib ./cds_libs/cpu.cds.lib                                                               
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_debug_slave_wrapper.v"                     -work cpu                                                                -cdslib ./cds_libs/cpu.cds.lib                                                               
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_debug_slave_sysclk.v"                      -work cpu                                                                -cdslib ./cds_libs/cpu.cds.lib                                                               
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_debug_slave_tck.v"                         -work cpu                                                                -cdslib ./cds_libs/cpu.cds.lib                                                               
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_mult_cell.v"                               -work cpu                                                                -cdslib ./cds_libs/cpu.cds.lib                                                               
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_cpu_test_bench.v"                              -work cpu                                                                -cdslib ./cds_libs/cpu.cds.lib                                                               
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_customins_slave_translator.sv"                                  -work nios2_gen2_0_custom_instruction_master_multi_slave_translator0     -cdslib ./cds_libs/nios2_gen2_0_custom_instruction_master_multi_slave_translator0.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0_custom_instruction_master_multi_xconnect.sv"   -work nios2_gen2_0_custom_instruction_master_multi_xconnect              -cdslib ./cds_libs/nios2_gen2_0_custom_instruction_master_multi_xconnect.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_customins_master_translator.v"                                  -work nios2_gen2_0_custom_instruction_master_translator                  -cdslib ./cds_libs/nios2_gen2_0_custom_instruction_master_translator.cds.lib                 
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_sysid_qsys_0.v"                                             -work sysid_qsys_0                                                       -cdslib ./cds_libs/sysid_qsys_0.cds.lib                                                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_sysid.v"                                                    -work sysid                                                              -cdslib ./cds_libs/sysid.cds.lib                                                             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_sdram_controller_0.v"                                       -work sdram_controller_0                                                 -cdslib ./cds_libs/sdram_controller_0.cds.lib                                                
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_nios2_gen2_0.v"                                             -work nios2_gen2_0                                                       -cdslib ./cds_libs/nios2_gen2_0.cds.lib                                                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/lua_cpu.v"                                                             -work lua_cpu_0                                                          -cdslib ./cds_libs/lua_cpu_0.cds.lib                                                         
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_leds_0.v"                                                   -work leds_0                                                             -cdslib ./cds_libs/leds_0.cds.lib                                                            
