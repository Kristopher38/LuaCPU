...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/kris/intelFPGA_lite/16.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_leds_0.v"    -work leds_0    -cdslib ./cds_libs/leds_0.cds.lib   
